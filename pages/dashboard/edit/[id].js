            ...
            return (
                <form onSubmit={submitForm}>
                    ...
                    <div className="mb-4 w-full">
                        ...
                        <select id="input_invitation_male_child" name="inputInvitationMaleChild" className="bg-transparent block flex-1 min-w-0 w-full text-sm p-2.5 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Anak Ke" autoComplete="off" defaultValue={data.invitationData ? data.invitationData.male.child : ""}>
                    ...
                    {data.invitationCategory !== 3 && (
                        <>
                            ...
                            <div className="mb-4 w-full">
                                ...
                                <select id="input_invitation_female_child" name="inputInvitationFemaleChild" className="bg-transparent block flex-1 min-w-0 w-full text-sm p-2.5 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Anak Ke" autoComplete="off" defaultValue={data.invitationData ? data.invitationData.female.child : ""}>
                                    <option disabled>Anak Ke</option>
                                    <option value=" ">Kosongkan</option>
                                    <option value="Pertama">Pertama</option>
                                    <option value="Kedua">Kedua</option>
                            ...
                            {item.invitationData ? (
                                <>
                                    <div className="mb-4 grid w-full grid-cols-3 gap-3 md:grid-cols-4">
                                        <div className="flex cursor-pointer select-none flex-col items-center justify-center rounded-md border py-3 px-4 text-center text-gray-600 transition-shadow hover:shadow" onClick={() => setModalIsOpen(item.invitationData ? !modalIsOpen : modalIsOpen)}>
                                        ...
                                        <div className="flex cursor-pointer select-none flex-col items-center justify-center rounded-md border py-3 px-4 text-center text-gray-600 transition-shadow hover:shadow">
                                    ...
                                    <Modal modalTitle="Informasi Dasar" modalIsOpen={modalIsOpen} setModalIsOpen={setModalIsOpen}>
                                        <InputForm data={item} />
                                    </Modal>
                                </>
                            ) : (
