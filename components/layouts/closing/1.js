                ...
                <div className="glide__slide layout_cover text-center">
                    <div className="mx-auto h-full max-w-xl">
                        <div className="no-scrollbar flex h-full w-full flex-col items-center overflow-y-auto overflow-x-hidden p-5 before:m-auto before:content-[''] after:m-auto after:content-[''] ">
                            ...
                            <div className="animate_animated animate_fadeInDown animate_slow text-sm"><em>Kami yang berbahagia:</em></div>

                            <div className="mt-3 flex flex-col items-center justify-center text-center font-fontSecondary" style={{ color: item.invitationTheme ? Themes[item.invitationTheme].colorMain : Themes[1].colorMain }}>
                                {item.invitationCategory !== 3 ? (
                                    <>
                                        <span className="animate_animated animate_fadeInUp animate_slow text-3xl">{item.invitationData ? item.invitationData.female.name : "Haisha Azrina"}</span>
                                        <span className="animate_animated animate_fadeIn animate_slower absolute hidden">&amp;</span>
                                        <span className="animate_animated animate_fadeInUp animate_slow text-3xl">{item.invitationData ? item.invitationData.male.name : "Fariz Advaita Alhasan"}</span>
                                    </>
                                ) : (
                                    <>
                                        <span className="animate_animated animate_fadeInUp animate_slow text-3xl">{item.invitationData ? item.invitationData.male.nameFather : "Adzriel Fairuz"}</span>
                                        <span className="animate_animated animate_fadeIn animate_slower absolute hidden">&amp;</span>
                                        <span className="animate_animated animate_fadeInUp animate_slow text-3xl">{item.invitationData ? item.invitationData.male.nameMother : "Areta Mahfeen"}</span>
                                    </>
                                )}
